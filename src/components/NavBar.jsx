    ...
    <nav className='flex items-center justify-between p-6'>
      <div className='flex justify-between mr-6 w-full'>
        ...
        <div className='flex gap-4'>
          ...
          <Link className='hidden lg:block' to='/contact'>Contact</Link>
        </div>
      </div>
      <div className='block lg:hidden'>
        ...
        {showMenu && (
          <div className='absolute top-20 right-0 bg-gray-800 py-2 px-4 rounded shadow-lg'>
            <Link to='/proyects' className='block text-gray-200 hover:text-white py-2'>Projects</Link>
            <Link to='/contact' className='block text-gray-200 hover:text-white py-2'>Contact</Link>
          </div>
        )}
      </div>
    </nav>
